...
const TMPL_SERVER_GO = `// MACHINE GENERATED BY easycert (github.com/tredoe/easycert)
...
const TMPL_CLIENT_GO = `// MACHINE GENERATED BY easycert (github.com/tredoe/easycert)
// From {{.System}} ({{.Arch}}) with "{{.Version}}", on {{.Date}}
